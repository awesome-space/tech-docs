...
| [Overview](https://docs.spring.io/spring-framework/docs/5.3.25/reference/html/overview.html#overview)                 | history, design philosophy, feedback, getting started.  讲述 spring 的历史，设计思想，反馈，以及如何开始使用 Spring                 |
| --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| [Core](https://docs.spring.io/spring-framework/docs/5.3.25/reference/html/core.html#spring-core)                      | Spring 框架中的核心模块 IoC Container, Events, Resources, i18n, Validation, Data Binding, Type Conversion, SpEL, AOP. |
| [Testing](https://docs.spring.io/spring-framework/docs/5.3.25/reference/html/testing.html#testing)                    | Spring  测试模块 Mock Objects, TestContext Framework, Spring MVC Test, WebTestClient.                             |
